        ...
        <div className="prose prose-neutral dark:prose-invert prose-sm flex max-w-none flex-col gap-8">
          <section className="flex flex-col gap-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              By accessing and using Ahia, you agree to be bound by these Terms
          ...
          <section className="flex flex-col gap-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Permission is granted to temporarily access and use Ahia for
              personal, non-commercial transitory viewing and purchasing only.
          ...
          <section className="flex flex-col gap-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              possible. However, colors, dimensions, and other details may vary
              slightly due to screen settings and manufacturing processes. We
              reserve the right to limit quantities and refuse orders at our
              discretion.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              Ahia shall not be liable for any indirect, incidental, special,
