        ...
        <div className="prose prose-neutral dark:prose-invert prose-sm flex max-w-none flex-col gap-8">
          <section className="flex flex-col gap-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              email address, and shipping address when you create an account or
              place an order. We also collect information automatically,
          ...
          <section className="flex flex-col gap-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              communicate with you about your orders and account, improve our
              services and user experience, and send promotional communications
              (with your consent).
            </p>
          </section>
          ...
          <section className="flex flex-col gap-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              of your personal information. Your data is transmitted via Secure
              Socket Layer (SSL) technology and encrypted in our databases.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              assist in our marketing efforts. You can choose to disable cookies
              through your browser settings, but some parts of the site may not
              function properly.
            </p>
          </section>
          ...
          <section className="flex flex-col gap-3">
            ...
            <p className="text-sm leading-relaxed text-muted-foreground">
              ...
              data. You may also object to or restrict certain processing of
