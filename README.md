...
I use Bun for running the app. Backend is built with Hono. Admin and storefront will be built with Next.js. Stripe handles checkouts and payments. Database is PostgreSQL with Drizzle as the ORM.
